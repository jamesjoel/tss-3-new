...
const Turfs = () => {
    ...
    let handlePirce = (e) => {
        ...
        if (e.target.checked) {
            setTimingSlotArr((curr) => {
                return [...curr, e.target.value]
            })
            setPrice(++price);
        } else {
            setTimingSlotArr(curr => curr.filter(item => item != e.target.value));
            setPrice(--price);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{ width: "600px" }}>
                                                            <p style={{ fontSize: "14px" }}><b>100 off</b> Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum, voluptates inventore ea asperiores quo dicta!
                                                                <br />
                                                                <button className='btn btn-sm btn-info' onClick={apply} disabled={applyBtn} >Apply</button>
                                                            </p>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div className="alert alert-secondary">
                                            <table className='table'>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Coupon</td>
                                                        <td>{applyBtn ? "100.00" : "0.00"}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Final Amount</td>
                                                        <td>{turf.price * timingSlotArr.length - (applyBtn ? 100 : 0)}.00</td>
                                                    </tr>
                                                </tbody>
...
/*
    ...
    <lable>{ condi ? val1 : val1 }:00 {condi ? "AM" : "PM"}</lable>

    value={ condi ? val1 : val1 +":00"+ (condi ? "AM" : "PM")}
